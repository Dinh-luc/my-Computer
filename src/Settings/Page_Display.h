            ...
            if (pageState == STATE_PICK_BR) {
                if (key == 'U') {
                    ...
                    if (wallIndex == wallFileCount) {
                        ...
                        theme.wallpaperPath = tempPathList[wallIndex];
                    }
                    theme.saveSettings();
    ...
    private:
        ...
        void scanWallpapers() {
            wallFileCount = 0;
            tempPathList[wallFileCount++] = "ROM: Default 1";
            tempPathList[wallFileCount++] = "ROM: Default 2";
            tempPathList[wallFileCount++] = "ROM: Default 3";
            ...
            if (root && root.isDirectory()) {
                ...
                while(file && wallFileCount < 10) { 
                    ...
                    if (!name.startsWith("._") && (name.endsWith(".jpg") || name.endsWith(".bmp") || name.endsWith(".png"))) {
